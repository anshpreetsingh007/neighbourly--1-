      ...
      <div className="space-y-3">
        {isLoading ? (
          ...
          notifications.map((notification) => {
            ...
            return (
              <GlassCard
                key={notification.id}
                hover
                className="p-4 flex items-start gap-4 cursor-pointer border border-hairline"
              >
                <button
                  type="button"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[10px] text-faint font-bold uppercase tracking-tighter mt-2">
          ...
          <div className="text-center py-20 glass rounded-3xl border border-dashed border-hairline">
            ...
            <p className="text-faint font-bold uppercase tracking-widest text-sm">No Notifications Yet</p>
            <p className="text-[10px] text-faint mt-1 uppercase tracking-tight">We'll let you know when something happens</p>
          </div>
        )}
      </div>
    </div>
