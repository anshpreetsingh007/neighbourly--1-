    ...
    <div className="h-screen flex flex-col relative">
      ...
      <header className="p-4 md:p-6 glass-light backdrop-blur-3xl flex items-center justify-between z-10 border-b border-hairline sticky top-0 shadow-2xl">
        <div className="flex items-center gap-4">
          <button onClick={() => navigate('/chat')} className="p-2.5 hover:bg-black/5 rounded-2xl transition-all active:scale-90 bg-surface-1 border border-hairline">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
                ...
                />
                <div className="absolute -bottom-0.5 -right-0.5 w-3.5 h-3.5 bg-emerald-status border-2 border-hairline rounded-full shadow-sm" />
            </div>
            <div>
      ...
      <div className="p-6 md:p-8 absolute bottom-0 left-0 right-0 z-20 pointer-events-none">
        <div className="max-w-4xl mx-auto glass backdrop-blur-2xl rounded-3xl p-3 border border-hairline shadow-2xl pointer-events-auto flex gap-3 items-center">
          <button className="p-4 glass hover:bg-surface-2 rounded-2xl transition-all active:scale-95 group">
